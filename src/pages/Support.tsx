    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="p-6 flex-1">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
            ...
            <Button 
              ...
              onClick={() => window.open('mailto: bluepaycompany824@gmail.com')}
            >
              Contact via Email
            </Button>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
            ...
            <Button 
              className="w-full mt-4 bg-blue-600 hover:bg-blue-700"
              onClick={() => window.open('https://t.me/Lopezbeck')}
            >
              Open Telegram
            </Button>
          </div>
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
            ...
            <Button 
              className="w-full mt-4 bg-blue-600 hover:bg-blue-700"
              onClick={() => window.open('https://wa.me/2347048017754')}
            >
              Chat on WhatsApp
            </Button>
          </div>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-blue-600 font-medium mt-2">bluepaycompany824@gmail.com</p>
        </div>
      </div>
    </div>
  );
